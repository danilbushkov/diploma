...
\define@key{booktitleframe}{name}[]{\def\bktf@name{#1}}
...
% Определение команды с ключами и значениями
\define@key{booksubsequentframe}{page}[]{\def\bksf@page{#1}}
\define@key{booksubsequentframe}{tpga}[]{\def\bksf@tpga{#1}}
\define@key{booksubsequentframe}{paperformat}[]{\def\bksf@paperformat{#1}}


% Рамка последующих страниц бумажного формата
\newcommand{\booksubsequentframe}[1][]{
\setkeys{booksubsequentframe}{
	page,
	tpga,
	paperformat,
}
\setkeys{booksubsequentframe}{#1}
\simpleframe
\subsequenttable[
	tpga=\bksf@tpga,
	page=\bksf@page,
]
\topinsсriptionforbook[\bksf@tpga]
\paperformat{\bksf@paperformat}
}
